...
class ProviderSpec:
    ...
    display_name: str = ""          # shown in `0xclaw status`
...
PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    # === ACP local agent bridge ===========================================
    ProviderSpec(
        name="acp",
        keywords=("acp", "claude-code", "claude_code_acp"),
        env_key="",
        display_name="ACP",
        litellm_prefix="",
        skip_prefixes=(),
    ...
    # FLock.io: decentralized AI model hub, OpenAI-compatible, privacy-preserving.
    # Auth uses x-litellm-api-key header (extra_headers in config).
    ProviderSpec(
        name="flock",
        keywords=("flock",),
        env_key="FLOCK_API_KEY",
        display_name="FLock.io",
        ...
        is_local=False,
        detect_by_key_prefix="",
        detect_by_base_keyword="flock.io",
        default_api_base="https://api.flock.io/v1",
